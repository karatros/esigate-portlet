...
import fr.smile.renderer.CssCommonFixupRenderer;
...
public class AggregatorServlet extends HttpServlet {
	...
	private static final Logger LOG = Logger.getLogger(AggregatorServlet.class);
	...
	protected void service(HttpServletRequest request,
		...
		try {
			...
			if (isCssRewrite) {
				...
				/*renderers.add(new CssCommonFixupRenderer(driverConfig.getProperties().getProperty("cssClassAttr"),
						Boolean.parseBoolean(driverConfig.getProperties().getProperty("prefixCss"))));*/
			}
